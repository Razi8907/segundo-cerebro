...
const MES_LABEL: Record<Mes, string> = { abril: "Abril 2026", mayo: "Mayo 2026", junio: "Junio 2026", julio: "Julio 2026", agosto: "Agosto 2026", septiembre: "Septiembre 2026" };
...
export default function OpsBreakdown({
  ...
  const prevMes: Mes | null = mes === "septiembre" ? "agosto" : mes === "agosto" ? "julio" : mes === "julio" ? "junio" : mes === "junio" ? "mayo" : mes === "mayo" ? "abril" : null;
