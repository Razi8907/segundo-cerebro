                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div className="flex items-center gap-1">
                          <span className="text-sm font-medium text-white truncate block max-w-[130px]">{p.proveedor}</span>
                          {p.whatsapp && (
                            <a href={`https://wa.me/${p.whatsapp.replace(/[^0-9]/g, "")}`} target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 shrink-0" title={`WhatsApp: ${p.whatsapp}`}>
