        ...
        {ranked.slice(0, 9).map((p, i) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              {p.whatsapp ? (
                <a href={`https://wa.me/${p.whatsapp.replace(/[^0-9]/g, "")}`} target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-green-500 truncate hover:text-green-400 hover:underline" title={`Chat WhatsApp: ${p.whatsapp}`}>{p.proveedor}</a>
              ) : (
